...
namespace azure_proxy
{
    ...
    public:
        bool post_send_task(std::uint32_t sender_session_idx, ::uint32_t _task_session, const unsigned char* send_buffer, std::uint32_t buffer_size);
    ...
    protected:
		...
		bool post_send_task(std::uint32_t sender_session_idx, std::uint32_t session_idx, const unsigned char* send_buffer, std::uint32_t buffer_size, session_data_cmd data_type);
