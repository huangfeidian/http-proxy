...
namespace http_proxy
{
	...
	protected:
		...
		std::shared_ptr<socket_wrapper> client_socket;
		std::shared_ptr<socket_wrapper> server_socket;
	...
	public:
		...
		const std::uint32_t at_most_size = BUFFER_LENGTH;
	...
	protected:
		...
		virtual void report_error(const std::string &status_code, const std::string &status_description, const std::string &error_message);
