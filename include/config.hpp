...
{
	static const std::size_t MAX_REQUEST_HEADER_LENGTH = 8192;
	static const std::size_t MAX_RESPONSE_HEADER_LENGTH = 8192;
	static const std::size_t BUFFER_LENGTH = 4096;
	static const std::size_t MAX_HTTP_BUFFER_LENGTH = 8192;
